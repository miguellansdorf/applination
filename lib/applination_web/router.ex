defmodule ApplinationWeb.Router do
  use ApplinationWeb, :router

  import ApplinationWeb.UserAuth

  pipeline :browser do
    plug :accepts, ["html"]
    plug :fetch_session
    plug :fetch_live_flash
    plug :put_root_layout, html: {ApplinationWeb.Layouts, :root}
  ...
  if Application.compile_env(:applination, :dev_routes) do
    ...
    scope "/dev" do
      ...
      live_dashboard "/dashboard", metrics: ApplinationWeb.Telemetry
